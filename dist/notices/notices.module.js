...
NoticeModule = __decorate([
    common_1.Module({
        imports: [typeorm_1.TypeOrmModule.forFeature([notices_entity_1.Notice])],
        controllers: [notices_controller_1.NoticeController],
        providers: [notices_service_1.NoticeService],
